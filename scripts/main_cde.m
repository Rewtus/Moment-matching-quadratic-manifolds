...
p = size(B, 2);
m = size(C, 1);
freqs = -logspace(1, 3, r/2); % Frequencies to interpolate 

% Create 2x2 blocks for S
...
%% =========================================================================
%% Compute QM ROM Matrices (OFFLINE)
%% =========================================================================
...
%% =========================================================================
%% Simulate QM ROM and FOM to check online performance 
%% =========================================================================
...
% Save results
save_path = fullfile(data_dir, '1d_cde_results.mat');
save(save_path);
